...
@Field docker_repo = is_open_ci_env ? 'docker.io/trustedfirmware/ci-amd64-mbed-tls-ubuntu' : 'jenkins-mbedtls'
...
docker pull $PRIVATE_CONTAINER_REGISTRY/$docker_repo:$docker_image
"""
            break
...
--cap-add SYS_PTRACE $PRIVATE_CONTAINER_REGISTRY/$docker_repo:$docker_image $entrypoint_arguments
"""
}
